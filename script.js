...
const complimentList = user === "codm" ? [
    ...
    "Ты – как плейлист для особых вечеров… Всегда задаёшь жару). 🎶🔥",
    "Ты – как шоколад… Таешь у меня в руках. 🍫💋",
    "Ты – как идеальная подушка… Мне хочется зарыться в тебя лицом. 🛏️🔥",
    "Ты – как горячий душ… После тебя я не хочу выходить в реальность. 🚿💖",
    ...
    "Ты – как Captain Morgan… Опьяняешь и заводишь. 🍸🔥",
    "Ты – как любимый трек… Каждый раз хочется тебя снова и снова. 😏🔥",
    "Ты – как мой любимый сериал… Каждый вечер жду продолжения. 💬🔥"
];
